 ...
 */
if ( ! function_exists( 'idealabstarter_top_bar_r' ) ) {
	function idealabstarter_top_bar_r() {
		wp_nav_menu( array(
			'container'      => false,
 ...
 */
if ( ! function_exists( 'idealabstarter_mobile_nav' ) ) {
	function idealabstarter_mobile_nav() {
		wp_nav_menu( array(
			'container'      => false,                         // Remove nav container
			'menu'           => __( 'mobile-nav', 'idealabstarter' ),
...
if ( ! function_exists( 'idealabstarter_breadcrumb' ) ) {
	function idealabstarter_breadcrumb( $showhome = true, $separatorclass = false ) {
		...
		if ( ! is_front_page() ) {
			...
			if ( is_single() ) {
				...
				// Paginated archives
				echo '<li class="current item-current-' . get_query_var('paged') . '">' . __('Page', 'idealabstarter' ) . ' ' . get_query_var('paged') . '</li>';
